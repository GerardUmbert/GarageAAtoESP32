...
Write-Host "  [3] Transistor          - NPN transistor wired into the fob button pads (advanced)" -ForegroundColor White
Write-Host ""
...
$triggerMode = switch ($triggerChoice) {
    ...
    "2" { "MODE_RELAY"      }
    "3" { "MODE_TRANSISTOR" }
    "4" { "MODE_CAP_PULSE"  } # hidden, kept for backwards compatibility
    default {
