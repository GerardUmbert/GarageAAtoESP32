...
const LOCALES = {
  en: {
    ...
    hero_sub2:   '— and the ESP32 triggers your fob. No internet. No cloud.',
    hero_cta_play:   'Get on Google Play',
    hero_cta_github: 'GitHub',
    // ticker
    ticker: ['Android Auto','ESP32 BLE','No internet required','HMAC-SHA256 auth','Open source','Voice commands','No soldering option','Quick Settings tile','Deep sleep firmware'],
    // who section
    ...
    feat4_h: 'Auto-fire on arrival',feat4_p: 'The AA screen fires the open command automatically the first time it detects the ESP32 in BLE range. Once per session — no double-triggers.',
    ...
    feat6_h: 'Renter-friendly option',  feat6_p: "Can't open the fob? Option C uses a capacitive pulse on a Fingerbot — no soldering, no fob modification. Peel the tape off when you move out.",
    // how it works
    how_chip: 'The flow',
    ...
    step3_h: 'ESP32 verifies and fires',                         step3_p: 'The ESP32 at your garage validates the HMAC, triggers the relay/transistor/fingerbot, and sends a status notification back.',
    ...
    hw_a_h: 'Transistor', hw_a_badge: 'Recommended',
    hw_a_p: 'A single NPN transistor shorts the fob\'s button pads. Cheapest, lowest power, fastest response. Requires opening the fob and soldering 3 wires.',
    hw_a_t1: '~$0.10', hw_a_t2: 'Soldering required',
    hw_b_h: 'Relay module',
    hw_b_p: 'Same idea as A but with a 5V relay module — galvanic isolation, more beginner-friendly. Slightly more power draw and cost. Same wiring complexity.',
    hw_b_t1: '~$1', hw_b_t2: 'Soldering required',
    hw_c_h: 'Capacitive pulse', hw_c_badge: 'No soldering',
    hw_c_p: 'ESP32 sends a charge pulse to a piece of copper tape on the capacitive button of a Fingerbot Plus — which then presses the fob mechanically. Nothing is opened or soldered. Fully reversible.',
    hw_c_t1: 'Renter-friendly', hw_c_t2: '+0.5–1s latency',
    // deploy
  ...
  es: {
    ...
    hero_sub2:   '— y el ESP32 pulsa el mando por ti. Sin internet. Sin nube.',
    hero_cta_play:   'Descargar en Google Play',
    hero_cta_github: 'GitHub',
    ticker: ['Android Auto','ESP32 BLE','Sin internet','Autenticación HMAC-SHA256','Código abierto','Comandos de voz','Sin soldadura','Acceso rápido','Bajo consumo'],
    ...
    feat4_h: 'Disparo automático',        feat4_p: 'La pantalla de AA dispara el comando de apertura automáticamente la primera vez que detecta el ESP32 en rango BLE. Una vez por sesión.',
    ...
    feat6_h: 'Opción para inquilinos',    feat6_p: '¿No puedes abrir el mando? La opción C usa un pulso capacitivo en un Fingerbot — sin soldadura, sin modificar el mando.',
    how_chip: 'El flujo',
    ...
    step3_h: 'El ESP32 verifica y actúa',                        step3_p: 'El ESP32 en tu garaje valida el HMAC, activa el relé/transistor/fingerbot y devuelve una notificación de estado.',
    ...
    hw_a_h: 'Transistor', hw_a_badge: 'Recomendado',
    hw_a_p: 'Un solo transistor NPN cortocircuita los pads del botón del mando. Más barato, menos consumo, respuesta más rápida. Requiere abrir el mando y soldar 3 cables.',
    hw_a_t1: '~$0.10', hw_a_t2: 'Soldadura requerida',
    hw_b_h: 'Módulo relé',
    hw_b_p: 'La misma idea que A pero con un módulo relé de 5V — aislamiento galvánico, más amigable para principiantes. Algo más de consumo y coste.',
    hw_b_t1: '~$1', hw_b_t2: 'Soldadura requerida',
  ...
  fr: {
    ...
    hero_sub2:   '— et l\'ESP32 appuie sur la télécommande. Sans internet. Sans cloud.',
    hero_cta_play:   'Télécharger sur Google Play',
    hero_cta_github: 'GitHub',
    ticker: ['Android Auto','ESP32 BLE','Sans internet','Auth HMAC-SHA256','Open source','Commandes vocales','Sans soudure','Tuile accès rapide','Firmware basse conso'],
    ...
    feat4_h: 'Déclenchement auto',     feat4_p: "L'écran AA déclenche la commande d'ouverture automatiquement à la première détection de l'ESP32 à portée BLE. Une fois par session.",
    ...
    feat6_h: 'Option locataire',       feat6_p: "Impossible d'ouvrir la télécommande ? L'option C utilise une impulsion capacitive sur un Fingerbot — sans soudure, sans modification.",
    how_chip: 'Le flux',
    ...
    step3_h: "L'ESP32 vérifie et agit", step3_p: "L'ESP32 dans votre garage valide le HMAC, déclenche le relais/transistor/fingerbot et renvoie une notification de statut.",
    ...
    hw_a_h: 'Transistor', hw_a_badge: 'Recommandé',
    hw_a_p: 'Un seul transistor NPN court-circuite les pads du bouton de la télécommande. Le moins cher, la plus faible consommation, la réponse la plus rapide.',
    hw_a_t1: '~0,10 $', hw_a_t2: 'Soudure requise',
    hw_b_h: 'Module relais',
    hw_b_p: "Même principe que A mais avec un module relais 5V — isolation galvanique, plus accessible aux débutants. Légèrement plus de consommation.",
    hw_b_t1: '~1 $', hw_b_t2: 'Soudure requise',
  ...
  de: {
    ...
    hero_sub2:   '— und der ESP32 drückt die Fernbedienung für dich. Kein Internet. Keine Cloud.',
    hero_cta_play:   'Bei Google Play herunterladen',
    hero_cta_github: 'GitHub',
    ticker: ['Android Auto','ESP32 BLE','Kein Internet','HMAC-SHA256-Auth','Open Source','Sprachbefehle','Kein Löten','Schnelleinstellungs-Kachel','Tiefer Schlaf'],
    ...
    feat4_h: 'Automatisches Auslösen',         feat4_p: 'Der AA-Bildschirm sendet den Öffnungsbefehl automatisch, wenn der ESP32 das erste Mal in BLE-Reichweite erkannt wird. Einmal pro Sitzung.',
    ...
    feat6_h: 'Mieterfreundliche Option',       feat6_p: 'Kannst du die Fernbedienung nicht öffnen? Option C nutzt einen kapazitiven Impuls auf einem Fingerbot — kein Löten, keine Modifikation.',
    how_chip: 'Der Ablauf',
    ...
    step3_h: 'ESP32 verifiziert und löst aus',                   step3_p: 'Der ESP32 in deiner Garage validiert den HMAC, löst Relais/Transistor/Fingerbot aus und sendet eine Statusbenachrichtigung zurück.',
    ...
    hw_a_h: 'Transistor', hw_a_badge: 'Empfohlen',
    hw_a_p: 'Ein einziger NPN-Transistor schließt die Tastenfelder der Fernbedienung kurz. Günstigste Option, niedrigster Verbrauch, schnellste Reaktion.',
    hw_a_t1: '~0,10 $', hw_a_t2: 'Löten erforderlich',
    hw_b_h: 'Relaismodul',
    hw_b_p: 'Gleiche Idee wie A, aber mit einem 5-V-Relaismodul — galvanische Trennung, einsteigerfreundlicher. Etwas mehr Verbrauch und Kosten.',
    hw_b_t1: '~1 $', hw_b_t2: 'Löten erforderlich',
  ...
  ca: {
    ...
    hero_h1_b:   'abans que pares el cotxe',
    hero_sub:    'Un toc a la pantalla d\'Android Auto — o digues',
    hero_sub_em: '"Obre el garatge"',
    hero_sub2:   '— i l\'ESP32 prem el comandament per tu. Sense internet. Sense núvol.',
    hero_cta_play: 'Descarrega a Google Play',
    hero_cta_github: 'GitHub',
    ticker: ['Android Auto','ESP32 BLE','Sense internet','Auth HMAC-SHA256','Codi obert','Ordres de veu','Sense soldadura','Accés ràpid','Firmware baix consum'],
    ...
    feat4_h: 'Activació automàtica',     feat4_p: 'La pantalla d\'AA envia l\'ordre d\'obertura automàticament la primera vegada que detecta l\'ESP32 al rang BLE. Una vegada per sessió.',
    ...
    feat6_h: 'Opció per a llogaters',   feat6_p: 'No pots obrir el comandament? L\'opció C usa un pols capacitiu en un Fingerbot — sense soldadura, sense modificació.',
    how_chip: 'El flux',
    ...
    step3_h: 'L\'ESP32 verifica i actua',                           step3_p: 'L\'ESP32 al teu garatge valida el HMAC, activa el relé/transistor/fingerbot i retorna una notificació d\'estat.',
    ...
    hw_a_h: 'Transistor', hw_a_badge: 'Recomanat',
    hw_a_p: 'Un sol transistor NPN curtcircuita els pads del botó del comandament. Més barat, menys consum, resposta més ràpida.',
    hw_a_t1: '~$0.10', hw_a_t2: 'Soldadura requerida',
    hw_b_h: 'Mòdul relé',
    hw_b_p: 'La mateixa idea que A però amb un mòdul relé de 5V — aïllament galvànic, més amigable per a principiants.',
    hw_b_t1: '~$1', hw_b_t2: 'Soldadura requerida',
  ...
  it: {
    ...
    hero_sub2:   '— e l\'ESP32 preme il telecomando al posto tuo. Senza internet. Senza cloud.',
    hero_cta_play: 'Scarica su Google Play',
    hero_cta_github: 'GitHub',
    ticker: ['Android Auto','ESP32 BLE','Senza internet','Auth HMAC-SHA256','Open source','Comandi vocali','Senza saldatura','Riquadro accesso rapido','Firmware basso consumo'],
    ...
    feat4_h: 'Attivazione automatica',     feat4_p: 'Lo schermo AA invia il comando di apertura automaticamente la prima volta che rileva l\'ESP32 nel raggio BLE. Una volta per sessione.',
    ...
    feat6_h: 'Opzione affittuari',         feat6_p: 'Non puoi aprire il telecomando? L\'opzione C usa un impulso capacitivo su un Fingerbot — niente saldatura, niente modifiche.',
    how_chip: 'Il flusso',
    ...
    step3_h: 'L\'ESP32 verifica e agisce',                          step3_p: 'L\'ESP32 nel tuo garage valida l\'HMAC, attiva il relè/transistor/fingerbot e invia una notifica di stato.',
    ...
    hw_a_h: 'Transistor', hw_a_badge: 'Consigliato',
    hw_a_p: 'Un singolo transistor NPN cortocircuita i pad del pulsante del telecomando. Il più economico, minor consumo, risposta più rapida.',
    hw_a_t1: '~$0.10', hw_a_t2: 'Saldatura richiesta',
    hw_b_h: 'Modulo relè',
    hw_b_p: 'Stessa idea di A ma con un modulo relè 5V — isolamento galvanico, più adatto ai principianti. Leggermente più consumo e costo.',
    hw_b_t1: '~$1', hw_b_t2: 'Saldatura richiesta',
    ...
    hero_sub2:   '— ja ESP32 painaa kaukosäädintä puolestasi. Ei internetiä. Ei pilveä.',
    hero_cta_play: 'Lataa Google Playsta',
    hero_cta_github: 'GitHub',
    ticker: ['Android Auto','ESP32 BLE','Ei internetiä','HMAC-SHA256-todennus','Avoin lähdekoodi','Äänikomennot','Ei juottamista','Pika-asetus-ruutu','Syväuni-laiteohjelmisto'],
    who_chip: 'Tilanne',
    ...
    feat4_h: 'Automaattinen laukaisu', feat4_p: 'AA-näyttö lähettää avauskomennon automaattisesti ensimmäistä kertaa kun ESP32 havaitaan BLE-kantamassa. Kerran per istunto.',
    ...
    feat6_h: 'Vuokraajaystävällinen vaihtoehto', feat6_p: 'Etkö voi avata kaukosäädintä? Vaihtoehto C käyttää kapasitiivista pulssia Fingerbotissa — ei juottamista, ei muutoksia.',
    how_chip: 'Kulku',
    ...
    step3_h: 'ESP32 tarkistaa ja laukaisee', step3_p: 'Autotallisi ESP32 vahvistaa HMAC:n, laukaisee releen/transistorin/fingerbotin ja lähettää tilasilmoituksen takaisin.',
    ...
    hw_a_h: 'Transistori', hw_a_badge: 'Suositeltu',
    hw_a_p: 'Yksi NPN-transistori oikosulkee kaukosäätimen nappilevyt. Halvin, pienin virrankulutus, nopein vastaus.',
    hw_a_t1: '~$0.10', hw_a_t2: 'Juottaminen vaaditaan',
    hw_b_h: 'Reletmoduuli',
    hw_b_p: 'Sama idea kuin A mutta 5V-reletmoduulilla — galvaaninen eristys, helpompi aloittelijoille. Hieman enemmän virtaa ja hintaa.',
    hw_b_t1: '~$1', hw_b_t2: 'Juottaminen vaaditaan',
  ...
  pt: {
    ...
    hero_sub2:   '— e o ESP32 carrega no comando por ti. Sem internet. Sem cloud.',
    hero_cta_play: 'Transferir no Google Play',
    hero_cta_github: 'GitHub',
    ticker: ['Android Auto','ESP32 BLE','Sem internet','Auth HMAC-SHA256','Código aberto','Comandos de voz','Sem soldar','Mosaico de acesso rápido','Firmware baixo consumo'],
    who_chip: 'A situação',
    ...
    feat4_h: 'Disparo automático',       feat4_p: 'O ecrã AA envia o comando de abertura automaticamente na primeira vez que deteta o ESP32 no alcance BLE. Uma vez por sessão.',
    ...
    feat6_h: 'Opção para inquilinos',    feat6_p: 'Não podes abrir o comando? A opção C usa um pulso capacitivo num Fingerbot — sem soldar, sem modificações.',
    how_chip: 'O fluxo',
    ...
    step3_h: 'O ESP32 verifica e atua',                     step3_p: 'O ESP32 na tua garagem valida o HMAC, aciona o relé/transistor/fingerbot e envia uma notificação de estado.',
    ...
    hw_a_h: 'Transistor', hw_a_badge: 'Recomendado',
    hw_a_p: 'Um único transistor NPN curto-circuita os pads do botão do comando. O mais barato, menor consumo, resposta mais rápida.',
    hw_a_t1: '~$0.10', hw_a_t2: 'Soldadura necessária',
    hw_b_h: 'Módulo de relé',
    hw_b_p: 'Mesma ideia que A mas com um módulo de relé de 5V — isolamento galvânico, mais acessível para iniciantes.',
    hw_b_t1: '~$1', hw_b_t2: 'Soldadura necessária',
